...
// Function NavigationSystem.NavModifierComponent.SetFailsafeExtent
// (Final, Native, Public, HasOutParms, HasDefaults, BlueprintCallable)
// Parameters:
// struct FVector                 NewExtent                      (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
// bool                           bRefreshBounds                 (Parm, ZeroConstructor, IsPlainOldData)

void UNavModifierComponent::SetFailsafeExtent(const struct FVector& NewExtent, bool bRefreshBounds)
{
	static auto fn = UObject::FindObject<UFunction>("Function NavigationSystem.NavModifierComponent.SetFailsafeExtent");

	UNavModifierComponent_SetFailsafeExtent_Params params;
	params.NewExtent = NewExtent;
	params.bRefreshBounds = bRefreshBounds;
