...
// Function BP_BTL_SKS_BEAUTIFUL_CRT_DAMAGE_UP.BP_BTL_SKS_BEAUTIFUL_CRT_DAMAGE_UP_C.Received_IsCalculateDamageAddCondition
...
bool UBP_BTL_SKS_BEAUTIFUL_CRT_DAMAGE_UP_C::Received_IsCalculateDamageAddCondition(class ABtlCharacterBase* AttackerActor, const TScriptInterface<class UBtlAttackCollisionInterface>& AttackCollision, class ABtlCharacterBase* DmgActor, class UBtlDamageSphereComponent* DmgCollision, const struct FBtlArtsHandle& ArtsHandle, const struct FBtlArtsData& ArtsData, bool IsGuard, bool IsCritical, bool IsWeakness, bool IsResistanc)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BTL_SKS_BEAUTIFUL_CRT_DAMAGE_UP.BP_BTL_SKS_BEAUTIFUL_CRT_DAMAGE_UP_C.Received_IsCalculateDamageAddCondition");

	UBP_BTL_SKS_BEAUTIFUL_CRT_DAMAGE_UP_C_Received_IsCalculateDamageAddCondition_Params params;
