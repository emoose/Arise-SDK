...
// WidgetBlueprintGeneratedClass UMG_Navimap_IconImage.UMG_Navimap_IconImage_C
// 0x001C (0x0224 - 0x0208)
class UUMG_Navimap_IconImage_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UMG_Navimap_IconImage.UMG_Navimap_IconImage_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_UMG_Navimap_IconImage(int EntryPoint);
};
