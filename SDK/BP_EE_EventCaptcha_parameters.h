...
struct UBP_EE_EventCaptcha_C_GetCaptureImage_Params
{
...
struct UBP_EE_EventCaptcha_C_GetEndAnimation_Params
{
...
struct UBP_EE_EventCaptcha_C_GetLoopAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function BP_EE_EventCaptcha.BP_EE_EventCaptcha_C.GetStartAnimation
struct UBP_EE_EventCaptcha_C_GetStartAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};
