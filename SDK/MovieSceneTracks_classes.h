...
public:
	...
	struct FMovieScene3DTransformCustomParam           CustomParam;                                              // 0x072D(0x0003) (Edit)
...
{
public:
	bool                                               bDisableIfOverrided;                                      // 0x0178(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EMovieSceneSpawnStreamingType                      StreamingType;                                            // 0x0179(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
