...
struct FCameraLookatTrackingSettings
{
	...
	struct FName                                       BoneOrSocketName;                                         // 0x0020(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     RelativeOffset;                                           // 0x0028(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      bAllowRoll : 1;                                           // 0x0034(0x0001) (Edit, BlueprintVisible)
