...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_SYS.TO14_BPI_GUI_MNU_SYS_C
// 0x0021 (0x0229 - 0x0208)
class UTO14_BPI_GUI_MNU_SYS_C : public UUserWidget
{
public:
	...
	class UTO14_BPI_GUI_MNU_SYS_CMD_LIST_C*            CMD_LIST;                                                 // 0x0220(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	bool                                               CloseFlag;                                                // 0x0228(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_SYS.TO14_BPI_GUI_MNU_SYS_C");
		return ptr;
	}
	...
	void OnViewClose();
	void Construct();
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_SYS(int EntryPoint);
};
