...
// Enum MovieScene.EMovieSceneEventType
enum class EMovieSceneEventType : uint8_t
{
	EMovieSceneEventType__None     = 0,
	EMovieSceneEventType__S        = 1,
	EMovieSceneEventType__A        = 2,
	EMovieSceneEventType__B        = 3,
	EMovieSceneEventType__Battle   = 4,
	EMovieSceneEventType__EMovieSceneEventType_MAX = 5
};
...
struct FMovieSceneSequencePlaybackSettings
{
	...
	bool                                               bEnableInPlayCheck;                                       // 0x0020(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0021(0x0003) MISSED OFFSET
	float                                              UpdateStartDelta;                                         // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TScriptInterface<class UMovieSceneBindingOverridesInterface> BindingOverrides;                                         // 0x0028(0x0030) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0038(0x0010) MISSED OFFSET
};
