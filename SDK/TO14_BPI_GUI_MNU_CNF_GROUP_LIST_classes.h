...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_CNF_GROUP_LIST.TO14_BPI_GUI_MNU_CNF_GROUP_LIST_C
// 0x00E2 (0x02EA - 0x0208)
class UTO14_BPI_GUI_MNU_CNF_GROUP_LIST_C : public UUserWidget
{
public:
	...
	bool                                               IsChanged;                                                // 0x0260(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    ChangeCheck;                                              // 0x02D8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	bool                                               IsSave;                                                   // 0x02E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsNewGameStart;                                           // 0x02E9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_CNF_GROUP_LIST.TO14_BPI_GUI_MNU_CNF_GROUP_LIST_C");
		return ptr;
	}


	void IsNewGame(bool* OutIsNewGame);
	...
	void UpdateGameSaveData(bool InIsOverwrite);
	...
	void PadControl(class AMenuPadProcess* InPadProsess, TEnumAsByte<EConfigState>* OutState);
	...
	void Initialize();
	void ChangeCheck__DelegateSignature();
