...
{
public:
	int                                                SectionBaseX;                                             // 0x0580(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	int                                                SectionBaseY;                                             // 0x0584(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	...
	TArray<class UMaterialInstanceDynamic*>            MaterialInstancesDynamic;                                 // 0x05B8(0x0010) (ZeroConstructor, Transient)
	TArray<struct FWeightmapLayerAllocationInfo>       WeightmapLayerAllocations;                                // 0x05C8(0x0010) (ZeroConstructor)
	TArray<class UTexture2D*>                          WeightmapTextures;                                        // 0x05D8(0x0010) (ZeroConstructor)
	...
	TLazyObjectPtr<class ULandscapeHeightfieldCollisionComponent> CollisionComponent;                                       // 0x0644(0x001C) (ExportObject, InstancedReference, IsPlainOldData)
	struct FGuid                                       MapBuildDataId;                                           // 0x0660(0x0010) (IsPlainOldData)
	TArray<struct FGuid>                               IrrelevantLights;                                         // 0x0670(0x0010) (ZeroConstructor, Deprecated)
	int                                                CollisionMipLevel;                                        // 0x0680(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                SimpleCollisionMipLevel;                                  // 0x0684(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              NegativeZBoundsExtension;                                 // 0x0688(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PositiveZBoundsExtension;                                 // 0x068C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              StaticLightingResolution;                                 // 0x0690(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                ForcedLOD;                                                // 0x0694(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
{
public:
	TArray<class ULandscapeLayerInfoObject*>           ComponentLayerInfos;                                      // 0x0580(0x0010) (ZeroConstructor)
	...
	struct FGuid                                       HeightfieldGuid;                                          // 0x05B8(0x0010) (IsPlainOldData)
	struct FBox                                        CachedLocalBox;                                           // 0x05C8(0x001C) (IsPlainOldData)
...
{
public:
	struct FGuid                                       MeshGuid;                                                 // 0x0660(0x0010) (IsPlainOldData)
...
{
public:
	struct FGuid                                       LandscapeGuid;                                            // 0x0610(0x0010) (IsPlainOldData)
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x0620(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0630(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0631(0x000F) MISSED OFFSET
...
{
public:
	TArray<class ULandscapeSplineControlPoint*>        ControlPoints;                                            // 0x0580(0x0010) (ZeroConstructor)
	TArray<class ULandscapeSplineSegment*>             Segments;                                                 // 0x0590(0x0010) (ZeroConstructor)
	TArray<class UMeshComponent*>                      CookedForeignMeshComponents;                              // 0x05A0(0x0010) (ExportObject, ZeroConstructor)
