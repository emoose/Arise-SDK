...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_EQU_SKL_STR.TO14_BPI_GUI_MNU_EQU_SKL_STR_C
// 0x002C (0x027C - 0x0250)
class UTO14_BPI_GUI_MNU_EQU_SKL_STR_C : public UClickableWidgetBase
{
public:
	...
	int                                                TargetID;                                                 // 0x0278(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_EQU_SKL_STR.TO14_BPI_GUI_MNU_EQU_SKL_STR_C");
		return ptr;
	}


	void SetSkillText(const struct FModifiedText& ModText);
	...
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_EQU_SKL_STR(int EntryPoint);
};
