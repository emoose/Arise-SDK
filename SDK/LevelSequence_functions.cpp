...
// Function LevelSequence.LevelSequencePlayer.GetShotInfos
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// TArray<struct FMovieSceneShotInfo> ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

TArray<struct FMovieSceneShotInfo> ULevelSequencePlayer::GetShotInfos()
{
	static auto fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequencePlayer.GetShotInfos");

	ULevelSequencePlayer_GetShotInfos_Params params;
...
// Function LevelSequence.LevelSequencePlayer.GetCurrentCameraInfo
// (Final, Native, Public, HasOutParms, BlueprintCallable)
// Parameters:
// struct FMinimalViewInfo        OutInfo                        (Parm, OutParm)

void ULevelSequencePlayer::GetCurrentCameraInfo(struct FMinimalViewInfo* OutInfo)
{
	static auto fn = UObject::FindObject<UFunction>("Function LevelSequence.LevelSequencePlayer.GetCurrentCameraInfo");

	ULevelSequencePlayer_GetCurrentCameraInfo_Params params;
