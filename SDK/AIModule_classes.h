...
public:
	...
	class UNavMovementComponent*                       MovementComp;                                             // 0x0148(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x8];                                       // 0x0150(0x0008) MISSED OFFSET
	class ANavigationData*                             MyNavData;                                                // 0x0158(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x170];                                     // 0x0160(0x0170) MISSED OFFSET
...
public:
	...
	struct FVector                                     CrowdAgentMoveDirection;                                  // 0x02D8(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x02E4(0x0004) MISSED OFFSET
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x02E8(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x02F0(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x02F4(0x0004) (Deprecated, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x02F8(0x0004) (Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData02[0x24];                                      // 0x02FC(0x0024) MISSED OFFSET
