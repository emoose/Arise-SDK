...
struct UBP_MGC_TSK_TrackingRotation_C_Received_GetTaskName_Params
{
	struct FString                                     ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function BP_MGC_TSK_TrackingRotation.BP_MGC_TSK_TrackingRotation_C.Received_Tick
struct UBP_MGC_TSK_TrackingRotation_C_Received_Tick_Params
{
...
struct UBP_MGC_TSK_TrackingRotation_C_ExecuteUbergraph_BP_MGC_TSK_TrackingRotation_Params
{
