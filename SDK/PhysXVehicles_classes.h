...
public:
	...
	class AController*                                 OverrideController;                                       // 0x02F0(0x0008) (Net, ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	struct FVehicleEngineData                          EngineSetup;                                              // 0x02F8(0x0090) (Edit)
	struct FVehicleDifferential4WData                  DifferentialSetup;                                        // 0x0388(0x001C) (Edit)
	...
	struct FRuntimeFloatCurve                          SteeringCurve;                                            // 0x03D8(0x0078) (Edit)
