...
struct UBTT_PF_NPC_Action_Stand_Action_C_ReceiveTickAI_Params
{
...
struct UBTT_PF_NPC_Action_Stand_Action_C_ReceiveExecuteAI_Params
{
	class AAIController*                               OwnerController;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class APawn*                                       ControlledPawn;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UBTT_PF_NPC_Action_Stand_Action_C_ExecuteUbergraph_BTT_PF_NPC_Action_Stand_Action_Params
{
