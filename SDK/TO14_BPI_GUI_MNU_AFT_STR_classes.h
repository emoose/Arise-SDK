...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_AFT_STR.TO14_BPI_GUI_MNU_AFT_STR_C
// 0x0038 (0x0288 - 0x0250)
class UTO14_BPI_GUI_MNU_AFT_STR_C : public UClickableWidgetBase
{
public:
	...
	class UTO14_BPI_GUI_ICN_NEW_C*                     TO14_BPI_GUI_ICN_NEW;                                     // 0x0278(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_AFT_STR.TO14_BPI_GUI_MNU_AFT_STR_C");
		return ptr;
	}
	...
	void SetItemData(const struct FModifiedText& ArtifactName);
	...
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_AFT_STR(int EntryPoint);
};
