...
struct UBP_MGC_TSK_SceneDarknessEnd_C_Received_GetTaskName_Params
{
	struct FString                                     ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function BP_MGC_TSK_SceneDarknessEnd.BP_MGC_TSK_SceneDarknessEnd_C.Received_Begin
struct UBP_MGC_TSK_SceneDarknessEnd_C_Received_Begin_Params
{
};

// Function BP_MGC_TSK_SceneDarknessEnd.BP_MGC_TSK_SceneDarknessEnd_C.ExecuteUbergraph_BP_MGC_TSK_SceneDarknessEnd
struct UBP_MGC_TSK_SceneDarknessEnd_C_ExecuteUbergraph_BP_MGC_TSK_SceneDarknessEnd_Params
{
