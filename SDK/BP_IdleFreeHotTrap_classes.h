...
// BlueprintGeneratedClass BP_IdleFreeHotTrap.BP_IdleFreeHotTrap_C
// 0x004C (0x0374 - 0x0328)
class ABP_IdleFreeHotTrap_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_IdleFreeHotTrap.BP_IdleFreeHotTrap_C");
		return ptr;
	}


	void IsPlayIdleFreeHot(class AActor* InCharacter, bool* Out);
	...
	void ExecuteUbergraph_BP_IdleFreeHotTrap(int EntryPoint);
};
