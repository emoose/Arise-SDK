...
#pragma region Post-proc override init
  ...
  PostProcOverrides.LensFlareTints[0x8].R = -1;
  PostProcOverrides.LensFlareTints[0x8].G = -1;
  PostProcOverrides.LensFlareTints[0x8].B = -1;
  PostProcOverrides.LensFlareTints[0x8].A = -1;
...
if (PostProc_CopyValuesToCVars) \
  ...
  OVERRIDE_POSTPROC(LensFlareTints[0x8].R);
  OVERRIDE_POSTPROC(LensFlareTints[0x8].G);
  OVERRIDE_POSTPROC(LensFlareTints[0x8].B);
  OVERRIDE_POSTPROC(LensFlareTints[0x8].A);
...
#define OVERRIDE_CVAR(x) \
  ...
  OVERRIDE_CVAR(LensFlareTints[0x8].R);
  OVERRIDE_CVAR(LensFlareTints[0x8].G);
  OVERRIDE_CVAR(LensFlareTints[0x8].B);
  OVERRIDE_CVAR(LensFlareTints[0x8].A);
