...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_MAP2_TAB_REGION.TO14_BPI_GUI_MNU_MAP2_TAB_REGION_C
// 0x00CC (0x02D4 - 0x0208)
class UTO14_BPI_GUI_MNU_MAP2_TAB_REGION_C : public UUserWidget
{
public:
	...
	class UDynamicEntryBox*                            DYNAMIC_REGION_STR;                                       // 0x0220(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	TArray<class UTO14_BPI_GUI_MNU_MAP2_TAB_REGION_STR_C*> Strs;                                                     // 0x0250(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<struct FMapRegionData>                      RegionDatas;                                              // 0x02A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int                                                CurrentIndex;                                             // 0x02B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	int                                                SelectableStrNum;                                         // 0x02D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_MAP2_TAB_REGION.TO14_BPI_GUI_MNU_MAP2_TAB_REGION_C");
		return ptr;
	}


	void BindChangedSelectEvent(const struct FScriptDelegate& OnChangedSelect);
	void Refresh_FontName();
	...
	void Exec(class AMenuPadProcess* PadProcess);
	...
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_MAP2_TAB_REGION(int EntryPoint);
	void OnChangedSelect__DelegateSignature(const struct FString& RegionName);
