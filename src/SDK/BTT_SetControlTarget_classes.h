...
// BlueprintGeneratedClass BTT_SetControlTarget.BTT_SetControlTarget_C
// 0x0018 (0x00D8 - 0x00C0)
class UBTT_SetControlTarget_C : public UBTT_BtlBP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTT_SetControlTarget.BTT_SetControlTarget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTT_SetControlTarget(int EntryPoint);
};
