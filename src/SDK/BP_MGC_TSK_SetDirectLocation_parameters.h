...
struct UBP_MGC_TSK_SetDirectLocation_C_Received_GetTaskName_Params
{
	struct FString                                     ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function BP_MGC_TSK_SetDirectLocation.BP_MGC_TSK_SetDirectLocation_C.Received_Tick
struct UBP_MGC_TSK_SetDirectLocation_C_Received_Tick_Params
{
...
struct UBP_MGC_TSK_SetDirectLocation_C_Received_Begin_Params
{
};

// Function BP_MGC_TSK_SetDirectLocation.BP_MGC_TSK_SetDirectLocation_C.ExecuteUbergraph_BP_MGC_TSK_SetDirectLocation
struct UBP_MGC_TSK_SetDirectLocation_C_ExecuteUbergraph_BP_MGC_TSK_SetDirectLocation_Params
{
