...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_SYS_CURSOR2_ON.TO14_BPI_GUI_SYS_CURSOR2_ON_C
// 0x0018 (0x0220 - 0x0208)
class UTO14_BPI_GUI_SYS_CURSOR2_ON_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_SYS_CURSOR2_ON.TO14_BPI_GUI_SYS_CURSOR2_ON_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TO14_BPI_GUI_SYS_CURSOR2_ON(int EntryPoint);
};
