...
// BlueprintGeneratedClass BTT_SetNearestTarget.BTT_SetNearestTarget_C
// 0x0018 (0x00D8 - 0x00C0)
class UBTT_SetNearestTarget_C : public UBTT_BtlBP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTT_SetNearestTarget.BTT_SetNearestTarget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTT_SetNearestTarget(int EntryPoint);
};
