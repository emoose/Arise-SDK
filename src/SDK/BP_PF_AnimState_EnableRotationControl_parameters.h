...
struct UBP_PF_AnimState_EnableRotationControl_C_SetRotationControlEnable_Params
{
...
struct UBP_PF_AnimState_EnableRotationControl_C_ReceiveEndPlay_Params
{
...
struct UBP_PF_AnimState_EnableRotationControl_C_ReceiveFinishedTick_Params
{
	class UAnimInstance*                               AnimInstance;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_PF_AnimState_EnableRotationControl.BP_PF_AnimState_EnableRotationControl_C.ReceiveBeginPlay
struct UBP_PF_AnimState_EnableRotationControl_C_ReceiveBeginPlay_Params
{
	class UAnimInstance*                               AnimInstance;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
