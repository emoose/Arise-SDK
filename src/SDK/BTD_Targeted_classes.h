...
// BlueprintGeneratedClass BTD_Targeted.BTD_Targeted_C
// 0x0009 (0x00B9 - 0x00B0)
class UBTD_Targeted_C : public UBTD_BtlBP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTD_Targeted.BTD_Targeted_C");
		return ptr;
	}
