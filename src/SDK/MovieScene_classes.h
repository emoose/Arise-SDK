...
public:
	...
	struct FScriptMulticastDelegate                    OnPreStop;                                                // 0x03B0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFinished;                                               // 0x03C0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSkipped;                                                // 0x03D0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSkippedToEnd;                                           // 0x03E0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	TEnumAsByte<EMovieScenePlayerStatus>               Status;                                                   // 0x03F0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03F1(0x0003) MISSED OFFSET
	unsigned char                                      bReversePlayback : 1;                                     // 0x03F4(0x0001)
	unsigned char                                      UnknownData02[0xB];                                       // 0x03F5(0x000B) MISSED OFFSET
	class UMovieSceneSequence*                         Sequence;                                                 // 0x0400(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FFrameNumber                                StartTime;                                                // 0x0408(0x0004)
	int                                                DurationFrames;                                           // 0x040C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                CurrentNumLoops;                                          // 0x0410(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x14];                                      // 0x0414(0x0014) MISSED OFFSET
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                         // 0x0428(0x0048)
	unsigned char                                      UnknownData04[0x478];                                     // 0x0470(0x0478) MISSED OFFSET
	...
	void UnlockMaxUndilatedFrameTime();
	void Stop();
	...
	void Play();
	void Pause();
	void K2Node_SkipToNext();
	void K2Node_SkipToEvent(const struct FName& InEventName);
	void K2Node_SetSkipEnabled(bool bEnabled);
	void K2Node_SetEventType(EMovieSceneEventType InEventType);
	void K2Node_NotifyAllSkip();
	bool K2Node_IsSkipEnabled();
	bool K2Node_IsMovieDataLoaded();
	void K2Node_GetCurrentShotSkipPoints(TArray<struct FFrameNumber>* OutTimes, TArray<struct FString>* OutEvents);
	...
	class UObject* GetObjectTemplate(const struct FMovieSceneObjectBindingID& ObjectBindingId);
	float GetLength();
	...
	void GetCameraInfo(const struct FMovieSceneObjectBindingID& ObjectBindingId, float Position, struct FMinimalViewInfo* OutInfo);
	TArray<class UObject*> GetBoundObjects(const struct FMovieSceneObjectBindingID& ObjectBinding);
	TArray<struct FMovieSceneObjectBindingID> FindObjectBindingID(class UClass* ActorClass);
