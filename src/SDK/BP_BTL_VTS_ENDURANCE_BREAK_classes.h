...
// BlueprintGeneratedClass BP_BTL_VTS_ENDURANCE_BREAK.BP_BTL_VTS_ENDURANCE_BREAK_C
// 0x0038 (0x00C8 - 0x0090)
class UBP_BTL_VTS_ENDURANCE_BREAK_C : public UBtlVisualRootTaskBlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTL_VTS_ENDURANCE_BREAK.BP_BTL_VTS_ENDURANCE_BREAK_C");
		return ptr;
	}


	void Received_Begin();
	void ExecuteUbergraph_BP_BTL_VTS_ENDURANCE_BREAK(int EntryPoint);
};
