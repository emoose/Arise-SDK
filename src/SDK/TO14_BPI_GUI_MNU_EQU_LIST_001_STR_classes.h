...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_EQU_LIST_001_STR.TO14_BPI_GUI_MNU_EQU_LIST_001_STR_C
// 0x0028 (0x0278 - 0x0250)
class UTO14_BPI_GUI_MNU_EQU_LIST_001_STR_C : public UClickableWidgetBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_EQU_LIST_001_STR.TO14_BPI_GUI_MNU_EQU_LIST_001_STR_C");
		return ptr;
	}
	...
	bool OnDeselected();
	bool OnSelected();
	void SetText(const struct FModifiedText& ModText);
	void SetActive(bool Active);
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_3_OnMouseClickedEvent__DelegateSignature();
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_10_OnClickableAreaHoverEvent__DelegateSignature();
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_EQU_LIST_001_STR(int EntryPoint);
};
