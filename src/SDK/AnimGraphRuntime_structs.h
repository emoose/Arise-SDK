...
{
	bool                                               DistanceLocked;                                           // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EAnimPhysLinearConstraintType                      LinearXLimitType;                                         // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EAnimPhysLinearConstraintType                      LinearYLimitType;                                         // 0x0002(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EAnimPhysLinearConstraintType                      LinearZLimitType;                                         // 0x0003(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	bool                                               bIsGround;                                                // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDebugVisibility;                                         // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x6];                                       // 0x0002(0x0006) MISSED OFFSET
	struct FBoneReference                              DrivingBone;                                              // 0x0008(0x0018) (Edit)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	float                                              RestoringForce;                                           // 0x018C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLinearSpring;                                            // 0x0190(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAngularSpring;                                           // 0x0191(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0192(0x0002) MISSED OFFSET
	float                                              LinearSpringConstant;                                     // 0x0194(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AngularSpringConstant;                                    // 0x0198(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableWind;                                              // 0x019C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindWasEnabled;                                          // 0x019D(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x019E(0x0002) MISSED OFFSET
	float                                              WindScale;                                                // 0x01A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideLinearDamping;                                   // 0x01A4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01A5(0x0003) MISSED OFFSET
	float                                              LinearDampingOverride;                                    // 0x01A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularDamping;                                  // 0x01AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x01AD(0x0003) MISSED OFFSET
	float                                              AngularDampingOverride;                                   // 0x01B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularBias;                                     // 0x01B4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	bool                                               bDoUpdate;                                                // 0x01BC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x01BD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x01BE(0x0002) MISSED OFFSET
	int                                                NumSolverIterationsPreUpdate;                             // 0x01C0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumSolverIterationsPostUpdate;                            // 0x01C4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EDeltaTimeTypeForUpdateLimit                       DeltaTimeTypeForUpdateLimitOnFixedDeltaTime;              // 0x01C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x23];                                      // 0x01C9(0x0023) MISSED OFFSET
	...
	bool                                               bSkipGroundPlanar;                                        // 0x0249(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x6];                                       // 0x024A(0x0006) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x3];                                       // 0x0279(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData12[0x164];                                     // 0x028C(0x0164) MISSED OFFSET
};
...
struct FAnimLegIKDefinition
{
	...
	TEnumAsByte<EAxis>                                 KneePoleVectorAxis;                                       // 0x003D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x003E(0x0002) MISSED OFFSET
	float                                              KneePoleVectorLength;                                     // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData03[0x44];                                      // 0x020C(0x0044) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x250];                                     // 0x0570(0x0250) MISSED OFFSET
};
