...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_PAU_LIST_000_STR.TO14_BPI_GUI_MNU_PAU_LIST_000_STR_C
// 0x0028 (0x0278 - 0x0250)
class UTO14_BPI_GUI_MNU_PAU_LIST_000_STR_C : public UClickableWidgetBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_PAU_LIST_000_STR.TO14_BPI_GUI_MNU_PAU_LIST_000_STR_C");
		return ptr;
	}
	...
	void SetModifiedText(const struct FModifiedText& ModifiedText);
	void SetActive(bool IsActive);
	void SetMenuText(const struct FString& MenuText);
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_9_OnMouseClickedEvent__DelegateSignature();
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_16_OnClickableAreaHoverEvent__DelegateSignature();
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_PAU_LIST_000_STR(int EntryPoint);
};
