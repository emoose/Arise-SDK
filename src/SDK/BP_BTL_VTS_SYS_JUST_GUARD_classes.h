...
// BlueprintGeneratedClass BP_BTL_VTS_SYS_JUST_GUARD.BP_BTL_VTS_SYS_JUST_GUARD_C
// 0x0040 (0x00D0 - 0x0090)
class UBP_BTL_VTS_SYS_JUST_GUARD_C : public UBtlVisualRootTaskBlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTL_VTS_SYS_JUST_GUARD.BP_BTL_VTS_SYS_JUST_GUARD_C");
		return ptr;
	}


	void Received_Begin();
	void ExecuteUbergraph_BP_BTL_VTS_SYS_JUST_GUARD(int EntryPoint);
};
