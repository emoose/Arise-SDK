...
// BlueprintGeneratedClass BTT_SetMagicUserTarget.BTT_SetMagicUserTarget_C
// 0x0019 (0x00D9 - 0x00C0)
class UBTT_SetMagicUserTarget_C : public UBTT_BtlBP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTT_SetMagicUserTarget.BTT_SetMagicUserTarget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTT_SetMagicUserTarget(int EntryPoint);
};
