...
// ScriptStruct MovieSceneTracks.MovieScene3DTransformCustomParam
// 0x0003
struct FMovieScene3DTransformCustomParam
{
	E3DTransformAxis                                   Axis;                                                     // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCalcCapsule;                                             // 0x0001(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bCorrectYup;                                              // 0x0002(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FMovieSceneSkeletalAnimationParams
{
	...
	bool                                               bPartiallyOverride;                                       // 0x00C1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bLooping;                                                 // 0x00C2(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneComponentTransformSectionTemplate : public FMovieSceneEvalTemplate
{
	...
	struct FMovieScene3DTransformCustomParam           CustomParam;                                              // 0x0670(0x0003)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0673(0x0005) MISSED OFFSET
};
