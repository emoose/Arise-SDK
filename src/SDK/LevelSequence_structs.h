...
// ScriptStruct LevelSequence.MovieSceneShotInfo
// 0x0010
struct FMovieSceneShotInfo
{
	struct FFrameTime                                  StartFrame;                                               // 0x0000(0x0008) (Edit, BlueprintVisible)
	struct FFrameTime                                  EndFrame;                                                 // 0x0008(0x0008) (Edit, BlueprintVisible)
};
