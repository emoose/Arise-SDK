...
// BlueprintGeneratedClass TO14_SM_YOK_Prop_Woodshelf02_BP.TO14_SM_YOK_Prop_Woodshelf02_BP_C
// 0x0058 (0x0380 - 0x0328)
class ATO14_SM_YOK_Prop_Woodshelf02_BP_C : public AActor
{
public:
	class UStaticMeshComponent*                        TO14_SM_MP_Plate_mdl_002;                                 // 0x0328(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UStaticMeshComponent*                        TO14_SM_MP_Plate_mdl_001;                                 // 0x0330(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TO14_SM_YOK_Prop_Woodshelf02_BP.TO14_SM_YOK_Prop_Woodshelf02_BP_C");
		return ptr;
	}
