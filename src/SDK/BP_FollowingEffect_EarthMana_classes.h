...
// BlueprintGeneratedClass BP_FollowingEffect_EarthMana.BP_FollowingEffect_EarthMana_C
// 0x0016 (0x0358 - 0x0342)
class ABP_FollowingEffect_EarthMana_C : public ABP_FollowingEffect_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FollowingEffect_EarthMana.BP_FollowingEffect_EarthMana_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_FollowingEffect_EarthMana(int EntryPoint);
};
