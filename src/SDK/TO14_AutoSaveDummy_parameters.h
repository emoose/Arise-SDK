...
struct UTO14_AutoSaveDummy_C_RequestShow_Params
{
	bool                                               bShow;                                                    // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function TO14_AutoSaveDummy.TO14_AutoSaveDummy_C.Tick
struct UTO14_AutoSaveDummy_C_Tick_Params
{
...
struct UTO14_AutoSaveDummy_C_ExecuteUbergraph_TO14_AutoSaveDummy_Params
{
