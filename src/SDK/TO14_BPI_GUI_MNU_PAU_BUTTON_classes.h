...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_PAU_BUTTON.TO14_BPI_GUI_MNU_PAU_BUTTON_C
// 0x0028 (0x0278 - 0x0250)
class UTO14_BPI_GUI_MNU_PAU_BUTTON_C : public UClickableWidgetBase
{
public:
	...
	class UImage*                                      WIN;                                                      // 0x0270(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_PAU_BUTTON.TO14_BPI_GUI_MNU_PAU_BUTTON_C");
		return ptr;
	}
	...
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_6_OnMouseClickedEvent__DelegateSignature();
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_13_OnClickableAreaHoverEvent__DelegateSignature();
	void BndEvt__AriseClickableArea_0_K2Node_ComponentBoundEvent_0_OnClickableAreaHoverEvent__DelegateSignature();
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_PAU_BUTTON(int EntryPoint);
};
