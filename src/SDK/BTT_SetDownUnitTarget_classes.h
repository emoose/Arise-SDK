...
// BlueprintGeneratedClass BTT_SetDownUnitTarget.BTT_SetDownUnitTarget_C
// 0x0020 (0x00E0 - 0x00C0)
class UBTT_SetDownUnitTarget_C : public UBTT_BtlBP_C
{
public:
	...
	float                                              Distance;                                                 // 0x00DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTT_SetDownUnitTarget.BTT_SetDownUnitTarget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTT_SetDownUnitTarget(int EntryPoint);
};
