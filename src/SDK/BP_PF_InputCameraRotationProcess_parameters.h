...
struct ABP_PF_InputCameraRotationProcess_C_UserConstructionScript_Params
{
};

// Function BP_PF_InputCameraRotationProcess.BP_PF_InputCameraRotationProcess_C.ReceiveBeginPlay
struct ABP_PF_InputCameraRotationProcess_C_ReceiveBeginPlay_Params
{
};

// Function BP_PF_InputCameraRotationProcess.BP_PF_InputCameraRotationProcess_C.ReceiveTick
struct ABP_PF_InputCameraRotationProcess_C_ReceiveTick_Params
{
...
struct ABP_PF_InputCameraRotationProcess_C_ExecuteUbergraph_BP_PF_InputCameraRotationProcess_Params
{
