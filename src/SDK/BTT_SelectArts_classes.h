...
// BlueprintGeneratedClass BTT_SelectArts.BTT_SelectArts_C
// 0x0021 (0x00E1 - 0x00C0)
class UBTT_SelectArts_C : public UBTT_BtlBP_C
{
public:
	...
	bool                                               IsSetTarget;                                              // 0x00E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTT_SelectArts.BTT_SelectArts_C");
		return ptr;
	}


	void SelectTarget();
	void SelectArts(struct FName* Request);
	void ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn);
	void ExecuteUbergraph_BTT_SelectArts(int EntryPoint);
};
