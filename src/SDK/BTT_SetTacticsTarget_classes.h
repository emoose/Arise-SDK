...
// BlueprintGeneratedClass BTT_SetTacticsTarget.BTT_SetTacticsTarget_C
// 0x0018 (0x00D8 - 0x00C0)
class UBTT_SetTacticsTarget_C : public UBTT_BtlBP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTT_SetTacticsTarget.BTT_SetTacticsTarget_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTT_SetTacticsTarget(int EntryPoint);
};
