...
// WidgetBlueprintGeneratedClass TO14_BP_MenuFrameBase.TO14_BP_MenuFrameBase_C
// 0x001D (0x0225 - 0x0208)
class UTO14_BP_MenuFrameBase_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BP_MenuFrameBase.TO14_BP_MenuFrameBase_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_TO14_BP_MenuFrameBase(int EntryPoint);
