...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_BTL_UNQ_SKILL_ICON.TO14_BPI_GUI_BTL_UNQ_SKILL_ICON_C
// 0x0008 (0x0228 - 0x0220)
class UTO14_BPI_GUI_BTL_UNQ_SKILL_ICON_C : public UBtlIconWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_BTL_UNQ_SKILL_ICON.TO14_BPI_GUI_BTL_UNQ_SKILL_ICON_C");
		return ptr;
	}


	void SetIcon_Party(EArisePartyID PartyId);
