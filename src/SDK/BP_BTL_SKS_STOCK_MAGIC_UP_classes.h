...
// BlueprintGeneratedClass BP_BTL_SKS_STOCK_MAGIC_UP.BP_BTL_SKS_STOCK_MAGIC_UP_C
// 0x0000 (0x0050 - 0x0050)
class UBP_BTL_SKS_STOCK_MAGIC_UP_C : public UBtlStatusBuff_SkillBase
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_BTL_SKS_STOCK_MAGIC_UP.BP_BTL_SKS_STOCK_MAGIC_UP_C");
		return ptr;
	}
