...
// Function UMG.WidgetComponent.RedrawImmediate
// (Native, Public, BlueprintCallable)

void UWidgetComponent::RedrawImmediate()
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.WidgetComponent.RedrawImmediate");

	UWidgetComponent_RedrawImmediate_Params params;
...
// Function UMG.ScrollBox.GetChildFocusIndex
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// int                            UserIndex                      (Parm, ZeroConstructor, IsPlainOldData)
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UScrollBox::GetChildFocusIndex(int UserIndex)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.ScrollBox.GetChildFocusIndex");

	UScrollBox_GetChildFocusIndex_Params params;
	params.UserIndex = UserIndex;
