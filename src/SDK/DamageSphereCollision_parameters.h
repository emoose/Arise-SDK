...
struct UDamageSphereCollision_C_ReceiveBeginPlay_Params
{
};

// Function DamageSphereCollision.DamageSphereCollision_C.ReceiveEndPlay
struct UDamageSphereCollision_C_ReceiveEndPlay_Params
{
	TEnumAsByte<EEndPlayReason>                        EndPlayReason;                                            // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function DamageSphereCollision.DamageSphereCollision_C.OnComponentBeginOverlap_Event
struct UDamageSphereCollision_C_OnComponentBeginOverlap_Event_Params
{
...
struct UDamageSphereCollision_C_OnComponentEndOverlap_Event_Params
{
	class UPrimitiveComponent*                         OverlappedComponent;                                      // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      OtherActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class UPrimitiveComponent*                         OtherComp;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
struct UDamageSphereCollision_C_ExecuteUbergraph_DamageSphereCollision_Params
{
