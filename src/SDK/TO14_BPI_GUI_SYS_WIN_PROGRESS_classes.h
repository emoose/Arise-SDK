...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_SYS_WIN_PROGRESS.TO14_BPI_GUI_SYS_WIN_PROGRESS_C
// 0x0060 (0x0288 - 0x0228)
class UTO14_BPI_GUI_SYS_WIN_PROGRESS_C : public UBP_SysWin_PartsBase_C
{
public:
	...
	class UAriseTextWidget*                            Text;                                                     // 0x0248(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	struct FModifiedText                               SourceText;                                               // 0x0250(0x0038) (Edit, BlueprintVisible, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_SYS_WIN_PROGRESS.TO14_BPI_GUI_SYS_WIN_PROGRESS_C");
		return ptr;
	}


	void SetProgress(float Value);
	void ExecuteUbergraph_TO14_BPI_GUI_SYS_WIN_PROGRESS(int EntryPoint);
};
