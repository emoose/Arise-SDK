...
{
public:
	struct FNavGraphNode                               Node;                                                     // 0x0250(0x0018)
	class UNavigationGraphNodeComponent*               NextNodeComponent;                                        // 0x0268(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UNavigationGraphNodeComponent*               PrevNodeComponent;                                        // 0x0270(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	TArray<struct FNavigationLink>                     Links;                                                    // 0x0588(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	struct FVector                                     LinkRelativeStart;                                        // 0x0148(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     LinkRelativeEnd;                                          // 0x0154(0x000C) (Edit, IsPlainOldData)
	...
	struct FVector                                     ObstacleOffset;                                           // 0x0168(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     ObstacleExtent;                                           // 0x0174(0x000C) (Edit, IsPlainOldData)
...
public:
	...
	struct FVector                                     FailsafeExtent;                                           // 0x0130(0x000C) (Edit, IsPlainOldData)
	...
	void SetFailsafeExtent(const struct FVector& NewExtent, bool bRefreshBounds);
