...
// WidgetBlueprintGeneratedClass TO14_BPI_ICN_SKL.TO14_BPI_ICN_SKL_C
// 0x0008 (0x0210 - 0x0208)
class UTO14_BPI_ICN_SKL_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_ICN_SKL.TO14_BPI_ICN_SKL_C");
		return ptr;
	}


	void SetSkillIcon(int IconNo);
};
