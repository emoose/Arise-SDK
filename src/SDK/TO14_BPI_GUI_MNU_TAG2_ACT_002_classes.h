...
// WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_TAG2_ACT_002.TO14_BPI_GUI_MNU_TAG2_ACT_002_C
// 0x0090 (0x02E0 - 0x0250)
class UTO14_BPI_GUI_MNU_TAG2_ACT_002_C : public UClickableWidgetBase
{
public:
	...
	class UImage*                                      ICN;                                                      // 0x0270(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	class UTO14_BPI_GUI_ICN_CHARA_C*                   ICN_CHARA;                                                // 0x0278(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
	...
	struct FModifiedText                               ViewText;                                                 // 0x0290(0x0038) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FString                                     Label;                                                    // 0x02C8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class UTO14_BPI_GUI_SYS_CURSOR_C*                  SYS_CURSOR;                                               // 0x02D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass TO14_BPI_GUI_MNU_TAG2_ACT_002.TO14_BPI_GUI_MNU_TAG2_ACT_002_C");
		return ptr;
	}


	void CheckAnyLearnArts(const struct FName& ArtsLabel, bool* Lean, EArisePartyID* CharaID);
	void RefreshIconAsHeal(const struct FString& Label);
	void RefreshIconAsOther();
	void RefreshIconAsBuff(const struct FString& Label);
	void RefreshIconAsUseItem(const struct FString& Label);
	...
	void ExecuteUbergraph_TO14_BPI_GUI_MNU_TAG2_ACT_002(int EntryPoint);
};
