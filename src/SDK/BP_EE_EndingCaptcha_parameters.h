...
struct UBP_EE_EndingCaptcha_C_GetCaptureImage_Params
{
...
struct UBP_EE_EndingCaptcha_C_GetEndAnimation_Params
{
...
struct UBP_EE_EndingCaptcha_C_GetLoopAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function BP_EE_EndingCaptcha.BP_EE_EndingCaptcha_C.GetStartAnimation
struct UBP_EE_EndingCaptcha_C_GetStartAnimation_Params
{
	class UWidgetAnimation*                            ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};
