...
// BlueprintGeneratedClass PFT_EnSym_MoveTo.PFT_EnSym_MoveTo_C
// 0x0020 (0x0100 - 0x00E0)
class UPFT_EnSym_MoveTo_C : public UPFT_EnSym_Base2_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PFT_EnSym_MoveTo.PFT_EnSym_MoveTo_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_PFT_EnSym_MoveTo(int EntryPoint);
};
