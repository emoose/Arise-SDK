...
AutoGameAddress Addr_UGameViewportClient__SetupInitialLocalPlayer(
...
AutoGameAddress Addr_FPakPlatformFile__FindFileInPakFiles(
...
AutoGameAddress Addr_FPakPlatformFile__IsNonPakFilenameAllowed(
