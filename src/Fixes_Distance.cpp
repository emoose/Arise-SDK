...
GameAddress Addr_FAchCharacterLODData__ReadsData_Hook( // patch0: 0x1406D46A7, patch-2022-2: 0x14046eea8
  "FAchCharacterLODData::ReadsData_Hook",
  { 0x4C, 0x8B, 0xC7, 0x49, 0xC1, 0xE0, 0x02, 0x48, 0x8B, 0xD5, 0x48, 0x8B, 0xCE },
  +0xD
);
GameAddress Addr_FAchCharacterLODData__ReadsData_Trampoline( // patch0: 0x1406D4963, patch-2022-2: 0x14046ef42
...
GameAddress Addr_GetCSMMaxDistance_Patch( // patch0: 0x142382021, patch-2022-2: 0x141deb3e9
  "GetCSMMaxDistance_Patch",
  { 0xF3, 0x0F, 0x10, 0x40, 0x04, 0x0F, 0x2F, 0xC6, 0x72, 0x0B, 0x0F, 0x28, 0xF0, 0xF3, 0x0F, 0x5D, 0x35 },
  +0xD
);
GameAddress Addr_CharacterSkipLODs_Patch( // patch0: 0x1406D46C1, patch-2022-2: 0x14046eec0
  "CharacterSkipLODs_Patch",
  { 0x48, 0x8B, 0xC6, 0x66, 0x66, 0x0F, 0x1F, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00 },
  { 0x48, 0x8B, 0xC6, 0x66, 0x66, 0x66, 0x0F, 0x1F, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00 },
  -2
);
GameAddress Addr_UPFNpcCameraFadeComponent__UPFNpcCameraFadeComponent_CameraFarFadeInDistance( // patch0: 0x14116BD4D, patch-2022-2: 0x140ac235e
  ...
  { 0xC7, 0x83, 0x20, 0x01, 0x00, 0x00, 0x00, 0x00, 0x2F, 0x45 },
  +0x6
);
GameAddress Addr_UPFNpcCameraFadeComponent__UPFNpcCameraFadeComponent_CameraFarFadeOutDistance( // patch0: 0x14116BD57, patch-2022-2: 0x140ac2368
  ...
  { 0xC7, 0x83, 0x28, 0x01, 0x00, 0x00, 0x00, 0x00, 0x35, 0x45 },
  +0x6
);
...
GameAddress Addr_FPFNpcCameraSettingsData__ICppStructOps__Construct_CameraFarFadeInDistance( // patch0: 0x141180598, patch-2022-2: 0x140ac226b
  "FPFNpcCameraSettingsData::ICppStructOps::Construct_CameraFarFadeInDistance",
  { 0xC7, 0x00, 0x1C, 0x00, 0x00, 0x2F, 0x45 },
  +0x3
);
GameAddress Addr_FPFNpcCameraSettingsData__ICppStructOps__Construct_CameraFarFadeOutDistance( // patch0: 0x14118059F, patch-2022-2: 0x140ac2272
  "FPFNpcCameraSettingsData::ICppStructOps::Construct_CameraFarFadeOutDistance",
  { 0xC7, 0x00, 0x24, 0x00, 0x40, 0x35, 0x45 },
  +0x3
);
AutoGameAddress<uint32_t**> Addr_CVarUROEnable( // patch0: 0x1408ECD26
  "CVarUROEnable",
  { 0x48, 0x8B, 0x05, 0x00, 0x00, 0x00, 0x00, 0x83, 0x38, 0x00, 0x0F, 0x8E, 0x00, 0x00, 0x00, 0x00, 0x4C, 0x8B },
  +0x3,
...
GameAddress Addr_APFNpcManager__InitsDistances( // patch0: 0x140E1C860, patch-2022-2: 0x140abf260
  ...
  { 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8D, 0x4D, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8D, 0x4D, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x0F, 0x57, 0xC0 },
  -0x31
);
...
GameAddress Addr_APFNpcWalkSystem__CreateSpawnData( // patch0: 0x140E2B980, patch-2022-2: 0x140ac96a0
  "APFNpcWalkSystem::CreateSpawnData",
  { 0x4C, 0x8D, 0xA9, 0xA0, 0x03, 0x00, 0x00, 0xF2, 0x0F, 0x11, 0x81, 0x80, 0x03, 0x00, 0x00 },
  { 0x4C, 0x8D, 0xB1, 0xA0, 0x03, 0x00, 0x00, 0x45, 0x33, 0xE4, 0xF2, 0x0F, 0x11, 0x81, 0x80, 0x03, 0x00, 0x00 },
  -0x22
);
...
GameAddress Addr_AEncountGroup__IsSpawnRangePlayer( // patch0: 0x140DE6AE0, patch-2022-2: 0x140a8f160
  "AEncountGroup::IsSpawnRangePlayer",
  { 0x48, 0x8B, 0x83, 0x58, 0x01, 0x00, 0x00, 0x0F, 0x28, 0xE8 },
  { 0x00, 0x48, 0x8B, 0xCF, 0xF3, 0x0F, 0x58, 0xF6, 0xE8, 0x00, 0x00, 0x00, 0x00, 0x48 },
  -0x46
);
...
GameAddress Addr_UAchCharacterBuildComponent__SetCulling( // patch0: 0x1406B11B0, patch-2022-2: 0x140457c70
  "UAchCharacterBuildComponent::SetCulling",
  { 0x49, 0x8B, 0x9D, 0xE0, 0x00, 0x00, 0x00, 0x44, 0x0F, 0x44, 0xF1 },
  { 0x00, 0x4C, 0x89, 0x78, 0x00, 0x45, 0x8B, 0xF5, 0x0F, 0xB6, 0x81, 0xFC, 0x01, 0x00, 0x00, 0x45 },
  -0x2F
);
...
GameAddress Addr_FRelevancePacket__FRelevancePacket( // patch0: 0x141A3F7F0, patch-2022-2: 0x14153cb40
